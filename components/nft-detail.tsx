...
// Simple action icons without excessive colors or emojis
const getActionIcon = (action: string) => {
  ...
  if (action.includes('Planted')) return <Send size={12} className="mr-2 text-black" />
  if (action.includes('Uprooted')) return <Send size={12} className="mr-2 text-black" />
  if (action.includes('Transferred')) return <Send size={12} className="mr-2 text-black" />
  if (action.includes('Merged')) return <Activity size={12} className="mr-2 text-black" />
